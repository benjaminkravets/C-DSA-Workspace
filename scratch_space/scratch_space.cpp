...
int main(){
   ...
   //wrapper_2 uses const X& since this binds to rvalues and lvalue references, but now the arguments have to be const and the function won't be able to do the inrement.
   // const int& e = a;
   // const int& f = b;
   // wrapper_2(e,f);
   // wrapper_2(1,2);
